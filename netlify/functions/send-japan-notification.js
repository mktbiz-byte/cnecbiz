...
<p style="font-size:12px;color:#999;margin:0;">CNEC BIZ | support@cnecbiz.com</p>
  ...
  guide_confirm_request: (data) => ({
    ...
    sms: `[CNEC] ${data.creatorName}님, "${data.campaignName}" 가이드가 등록되었습니다. 마이페이지에서 확인 후 촬영을 시작해주세요. LINE친구추가: https://lin.ee/GuwmxOH`,
...
<p style="font-size:16px;color:#333;text-align:center;margin:30px 0;font-weight:bold;">マイページでご確認ください。</p>
</td></tr>
<tr><td style="background:#f9f9f9;padding:20px;text-align:center;border-top:1px solid #eee;">
<p style="font-size:12px;color:#999;margin:0;">CNEC BIZ | support@cnecbiz.com</p>
</td></tr>
