  ...
  try {
    ...
    switch (action) {
      ...
      case 'update_campaign': {
        // US DB campaigns 테이블에 존재하는 필드만 허용
        ...
        // 허용된 필드만 필터링 (updated_at, 일본어 필드 등 제외)
        const filteredData = {}
        ...
        console.log('[US API] update_campaign filtered fields:', Object.keys(filteredData), 'removed:', Object.keys(data).filter(k => !ALLOWED_CAMPAIGN_FIELDS.includes(k)))
