...
ALTER TABLE campaigns ADD COLUMN IF NOT EXISTS challenge_guide_data_ja JSONB DEFAULT '{}';
...
SELECT
  ...
  'https://psfwmzlnaboattocyupu.supabase.co/storage/v1/object/public/campaign-videos/' || name as video_file_url,
...
AND NOT EXISTS (
  ...
  WHERE vs.video_file_url = 'https://psfwmzlnaboattocyupu.supabase.co/storage/v1/object/public/campaign-videos/' || storage.objects.name
);
