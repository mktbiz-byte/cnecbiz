-- =====================================================
-- CNEC BIZ - Clean Installation (Drop & Recreate)
-- ⚠️ WARNING: This will delete ALL existing data!
-- =====================================================

-- Drop existing views first
DROP VIEW IF EXISTS revenue_stats CASCADE;

-- Drop existing tables in reverse dependency order
DROP TABLE IF EXISTS user_term_agreements CASCADE;
DROP TABLE IF EXISTS terms CASCADE;
DROP TABLE IF EXISTS points_charge_requests CASCADE;
DROP TABLE IF EXISTS points_transactions CASCADE;
DROP TABLE IF EXISTS points_balance CASCADE;
DROP TABLE IF EXISTS tax_invoices CASCADE;
DROP TABLE IF EXISTS documents CASCADE;
DROP TABLE IF EXISTS video_revisions CASCADE;
...
DROP TABLE IF EXISTS reference_videos CASCADE;

-- Drop functions
DROP FUNCTION IF EXISTS spend_points CASCADE;
DROP FUNCTION IF EXISTS add_points CASCADE;
DROP FUNCTION IF EXISTS get_points_balance CASCADE;
...
-- Copy and paste the entire COMPLETE_DATABASE_SCHEMA.sql content below this line
-- (Starting from "-- 1. Companies Table")
