-- =====================================================
-- Japan DB - 컬럼 존재 여부 검증 쿼리
-- cnec-japan-platform Supabase SQL Editor에서 실행
-- =====================================================
...
BEGIN
  RAISE NOTICE '========================================';
  RAISE NOTICE 'Japan DB Column Verification Start';
  RAISE NOTICE '========================================';
  ...
  -- 제품 정보
  FOREACH col_exists IN ARRAY ARRAY[
    EXISTS(SELECT 1 FROM information_schema.columns WHERE table_name='campaigns' AND column_name='product_description'),
    EXISTS(SELECT 1 FROM information_schema.columns WHERE table_name='campaigns' AND column_name='product_features'),
    EXISTS(SELECT 1 FROM information_schema.columns WHERE table_name='campaigns' AND column_name='additional_shooting_requests'),
    EXISTS(SELECT 1 FROM information_schema.columns WHERE table_name='campaigns' AND column_name='additional_details')
  ] LOOP
    total_checked := total_checked + 1;
    IF NOT col_exists THEN missing_count := missing_count + 1; END IF;
  END LOOP;
  ...
  IF NOT EXISTS(SELECT 1 FROM information_schema.columns WHERE table_name='campaigns' AND column_name='additional_shooting_requests') THEN
    RAISE NOTICE '  ❌ MISSING: campaigns.additional_shooting_requests';
  END IF;
  IF NOT EXISTS(SELECT 1 FROM information_schema.columns WHERE table_name='campaigns' AND column_name='additional_details') THEN
    RAISE NOTICE '  ❌ MISSING: campaigns.additional_details';
  END IF;

  -- 일본어 번역 컬럼
  IF NOT EXISTS(SELECT 1 FROM information_schema.columns WHERE table_name='campaigns' AND column_name='brand_name_ja') THEN
    RAISE NOTICE '  ❌ MISSING: campaigns.brand_name_ja'; missing_count := missing_count + 1;
  END IF;
  IF NOT EXISTS(SELECT 1 FROM information_schema.columns WHERE table_name='campaigns' AND column_name='product_name_ja') THEN
    RAISE NOTICE '  ❌ MISSING: campaigns.product_name_ja'; missing_count := missing_count + 1;
  END IF;
  IF NOT EXISTS(SELECT 1 FROM information_schema.columns WHERE table_name='campaigns' AND column_name='product_description_ja') THEN
    RAISE NOTICE '  ❌ MISSING: campaigns.product_description_ja'; missing_count := missing_count + 1;
  END IF;
  IF NOT EXISTS(SELECT 1 FROM information_schema.columns WHERE table_name='campaigns' AND column_name='product_features_ja') THEN
    RAISE NOTICE '  ❌ MISSING: campaigns.product_features_ja'; missing_count := missing_count + 1;
  END IF;
  IF NOT EXISTS(SELECT 1 FROM information_schema.columns WHERE table_name='campaigns' AND column_name='required_dialogues_ja') THEN
    RAISE NOTICE '  ❌ MISSING: campaigns.required_dialogues_ja'; missing_count := missing_count + 1;
  END IF;
  IF NOT EXISTS(SELECT 1 FROM information_schema.columns WHERE table_name='campaigns' AND column_name='required_scenes_ja') THEN
    RAISE NOTICE '  ❌ MISSING: campaigns.required_scenes_ja'; missing_count := missing_count + 1;
  END IF;
  IF NOT EXISTS(SELECT 1 FROM information_schema.columns WHERE table_name='campaigns' AND column_name='required_hashtags_ja') THEN
    RAISE NOTICE '  ❌ MISSING: campaigns.required_hashtags_ja'; missing_count := missing_count + 1;
  END IF;
  IF NOT EXISTS(SELECT 1 FROM information_schema.columns WHERE table_name='campaigns' AND column_name='video_duration_ja') THEN
    RAISE NOTICE '  ❌ MISSING: campaigns.video_duration_ja'; missing_count := missing_count + 1;
  END IF;
  IF NOT EXISTS(SELECT 1 FROM information_schema.columns WHERE table_name='campaigns' AND column_name='video_tempo_ja') THEN
    RAISE NOTICE '  ❌ MISSING: campaigns.video_tempo_ja'; missing_count := missing_count + 1;
  END IF;
  IF NOT EXISTS(SELECT 1 FROM information_schema.columns WHERE table_name='campaigns' AND column_name='video_tone_ja') THEN
    RAISE NOTICE '  ❌ MISSING: campaigns.video_tone_ja'; missing_count := missing_count + 1;
  END IF;
  IF NOT EXISTS(SELECT 1 FROM information_schema.columns WHERE table_name='campaigns' AND column_name='additional_details_ja') THEN
    RAISE NOTICE '  ❌ MISSING: campaigns.additional_details_ja'; missing_count := missing_count + 1;
  END IF;
  IF NOT EXISTS(SELECT 1 FROM information_schema.columns WHERE table_name='campaigns' AND column_name='additional_shooting_requests_ja') THEN
    RAISE NOTICE '  ❌ MISSING: campaigns.additional_shooting_requests_ja'; missing_count := missing_count + 1;
  END IF;
  IF NOT EXISTS(SELECT 1 FROM information_schema.columns WHERE table_name='campaigns' AND column_name='shooting_scenes_ja') THEN
    RAISE NOTICE '  ❌ MISSING: campaigns.shooting_scenes_ja'; missing_count := missing_count + 1;
  END IF;
  ...
  END IF;
  IF NOT EXISTS(SELECT 1 FROM information_schema.columns WHERE table_name='campaigns' AND column_name='challenge_guide_data_ja') THEN
    RAISE NOTICE '  ❌ MISSING: campaigns.challenge_guide_data_ja'; missing_count := missing_count + 1;
  END IF;
  ...
  ELSE
    ...
    RAISE NOTICE '→ japan_guide_columns_migration.sql을 실행하세요';
  END IF;
  RAISE NOTICE '========================================';
END $$;
