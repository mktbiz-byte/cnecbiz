...
export const KOREA_TEMPLATES = [
  ...
  // 신규 트렌드 템플릿 (2024-2025)
  {
    id: 'kr_asmr_review',
    type: 'ASMR',
    title: 'ASMR 감성 리뷰',
    subtitle: 'ASMR Sensory Review',
    description: '소리와 텍스처에 집중한 감각적 제품 리뷰',
    culturalNotes: 'ASMR 콘텐츠는 한국에서 인기가 높습니다. 조용한 환경에서 제품의 소리와 질감을 강조합니다.',
    toneGuide: '조용하고 차분한 톤, 속삭이는 듯한 목소리, "이 소리 들으세요", "질감 보세요"',
    platforms: ['youtube', 'tiktok'],
    duration: '60s',
    estimatedTime: '1~2시간',
    applicableCategories: ['skincare', 'makeup', 'bodycare', 'nail'],
    hashtags: ['#ASMR', '#뷰티ASMR', '#텍스처', '#감각리뷰', '#힐링'],
    defaultScenes: [
      '제품 패키징 열기 (소리 강조)',
      '제품 짜는 소리/텍스처 클로즈업',
      '손에 펴 바르는 모습 (마이크 가까이)',
  ...
  },
  {
    ...
    type: 'Shortping',
    title: '숏핑 스타일 리뷰',
    subtitle: 'Short-form Shopping Review',
    description: '짧고 임팩트 있게 쇼핑 포인트를 전달하는 스타일',
    culturalNotes: '짧은 시간 안에 핵심 정보 전달. "이거 사야 해" 느낌의 빠른 템포가 인기.',
    toneGuide: '빠르고 에너지 넘치는 톤, "이거 무조건 사세요!", "가성비 미쳤어요"',
    platforms: ['tiktok', 'instagram'],
    duration: '15s',
    estimatedTime: '30분',
    applicableCategories: ['skincare', 'makeup', 'haircare', 'bodycare', 'fragrance', 'nail', 'tool'],
    hashtags: ['#숏핑', '#쇼핑추천', '#머스트해브', '#꿀템', '#가성비'],
    defaultScenes: [
      '제품 빠르게 보여주기',
      '핵심 포인트 1 (3초)',
      '핵심 포인트 2 (3초)',
  ...
  },
  {
    ...
    type: 'Challenge',
    title: '챌린지 참여형',
    subtitle: 'Viral Challenge Content',
    description: '트렌드 챌린지에 참여하며 제품을 자연스럽게 노출',
    culturalNotes: '인기 챌린지에 참여하면 노출이 높아집니다. 재미와 공감을 동시에 전달합니다.',
    toneGuide: '재미있고 트렌디한 톤, 챌린지 관련 인기 사운드 활용',
    platforms: ['tiktok', 'instagram'],
    duration: '15s',
    estimatedTime: '30분~1시간',
    applicableCategories: ['makeup', 'haircare', 'nail', 'fragrance'],
    hashtags: ['#챌린지', '#뷰티챌린지', '#틱톡챌린지', '#바이럴'],
    defaultScenes: [
      '챌린지 시작 포즈',
      '제품 사용 장면',
      '챌린지 메인 동작',
  ...
  },
  {
    ...
    title: '갓생 모닝루틴',
    subtitle: 'Productive Morning Routine',
    description: '생산적인 아침을 보여주며 제품을 자연스럽게 노출하는 스타일',
    culturalNotes: '"갓생"(God+인생)은 자기계발과 생산적인 삶을 추구하는 MZ세대 트렌드입니다.',
    toneGuide: '차분하고 정돈된 톤, "오늘도 알차게", "아침을 지배하자"',
    platforms: ['youtube', 'instagram'],
    duration: '60s',
    estimatedTime: '1~2시간',
    applicableCategories: ['skincare', 'makeup', 'haircare', 'bodycare'],
    hashtags: ['#갓생', '#모닝루틴', '#자기관리', '#미라클모닝', '#아침루틴'],
    defaultScenes: [
      '이른 아침 기상',
      '물 마시기 & 스트레칭',
      '스킨케어 루틴',
  ...
  },
  {
    ...
    type: 'Holy Grail',
    title: '인생템 발견',
    subtitle: 'Holy Grail Product',
    description: '평생 쓸 것 같은 인생템을 발견했다는 스토리텔링',
    culturalNotes: '"인생템"은 한국에서 가장 높은 수준의 제품 추천 표현입니다.',
    toneGuide: '진심 어린 감동 톤, "드디어 찾았다!", "이거 없으면 못 살아요"',
    platforms: ['tiktok', 'instagram', 'youtube'],
    duration: '30s',
    estimatedTime: '30분~1시간',
    applicableCategories: ['skincare', 'makeup', 'haircare', 'bodycare', 'fragrance', 'nail', 'tool'],
    hashtags: ['#인생템', '#인생스킨케어', '#인생화장품', '#꿀템추천', '#재구매100번'],
    defaultScenes: [
      '고민했던 문제 소개',
      '인생템 발견 스토리',
      '제품 상세 보여주기',
  ...
  },
  {
    ...
    type: 'Glass Skin',
    title: '유리알 피부 만들기',
    subtitle: 'Glass Skin Tutorial',
    description: '투명하고 윤기나는 피부를 만드는 과정을 보여주는 스타일',
    culturalNotes: '유리알 피부(Glass Skin)는 K-뷰티를 대표하는 트렌드입니다.',
    toneGuide: '깔끔하고 전문적인 톤, "광채 피부 비결", "이렇게 하면 유리알 피부"',
    platforms: ['instagram', 'youtube', 'tiktok'],
    duration: '60s',
    estimatedTime: '1시간',
    applicableCategories: ['skincare', 'makeup'],
    hashtags: ['#유리알피부', '#광채피부', '#글로우스킨', '#스킨케어루틴', '#물광'],
    defaultScenes: [
      '깨끗한 베이스 피부',
      '보습 단계별 레이어링',
      '제품 바르는 테크닉',
  ...
  },
  {
    ...
    type: 'Office Look',
    title: '출근 메이크업',
    subtitle: 'Office Makeup Tutorial',
    description: '자연스럽고 단정한 출근 메이크업 튜토리얼',
    culturalNotes: '한국 직장인들의 깔끔하고 자연스러운 오피스 메이크업이 인기입니다.',
    toneGuide: '실용적이고 깔끔한 톤, "5분 만에 완성", "출근길에 딱"',
    platforms: ['instagram', 'youtube'],
    duration: '60s',
    estimatedTime: '1시간',
    applicableCategories: ['makeup', 'skincare'],
    hashtags: ['#출근메이크업', '#오피스룩', '#직장인메이크업', '#데일리메이크업', '#5분메이크업'],
    defaultScenes: [
      '베이스 메이크업',
      '자연스러운 눈화장',
      '제품 사용 포인트',
...
export const US_TEMPLATES = [
  ...
  // 신규 트렌드 템플릿 (2024-2025)
  {
    id: 'us_tiktok_shop',
    type: 'TikTok Shop',
    title: 'TikTok Shop Review',
    titleKr: '틱톡샵 리뷰',
    subtitle: 'Viral Shop Review',
    description: 'Review products from TikTok Shop with authentic reactions',
    culturalNotes: 'TikTok Shop reviews are trending. Authentic reactions and immediate purchase CTAs work best.',
    toneGuide: 'Excited, genuine. "TikTok made me buy it!", "Is it worth the hype?"',
    platforms: ['tiktok'],
    duration: '30s',
    estimatedTime: '30 min - 1 hour',
    applicableCategories: ['skincare', 'makeup', 'haircare', 'bodycare', 'tool'],
    hashtags: ['#TikTokShop', '#TikTokMadeMeBuyIt', '#ShopReview', '#ViralProducts'],
    defaultScenes: [
      'Show TikTok Shop purchase',
      'Unbox the viral product',
    ...
    defaultDialogues: [
      ...
      'Okay but this actually works!',
      'Link in my TikTok Shop!',
    ],
  },
  {
    id: 'us_deinfluencing',
    type: 'Deinfluencing',
    title: 'Honest Deinfluencing',
    titleKr: '디인플루언싱 (역추천)',
    subtitle: 'What NOT to Buy',
    description: 'Honest review about what to skip and what to buy instead',
    culturalNotes: 'Deinfluencing trend resonates with budget-conscious consumers seeking authentic opinions.',
    toneGuide: 'Honest, relatable. "Save your money!", "Get this instead"',
    platforms: ['tiktok', 'instagram'],
    duration: '30s',
    estimatedTime: '30 min',
    applicableCategories: ['skincare', 'makeup', 'haircare', 'bodycare', 'fragrance', 'nail', 'tool'],
    hashtags: ['#Deinfluencing', '#DontBuyThis', '#BeautyTruth', '#HonestOpinion'],
    defaultScenes: [
      'Show overhyped product',
      'Explain why not worth it',
      'Introduce better alternative',
      'Compare both products',
      'Recommend the winner',
    ],
    defaultDialogues: [
      'Stop buying this overhyped product!',
      'Here\'s why it\'s not worth your money',
      'Get this instead',
      'Same results, better price',
      'You\'re welcome!',
    ],
  },
  {
    id: 'us_that_girl',
    type: 'That Girl',
    title: 'That Girl Routine',
    titleKr: '"댓걸" 루틴',
    subtitle: 'Aesthetic Morning Routine',
    description: 'Aspirational morning routine with aesthetic visuals',
    culturalNotes: '"That Girl" aesthetic focuses on wellness, productivity, and self-care. Clean, minimal visuals.',
    toneGuide: 'Calm, aspirational. "Becoming that girl", "Wellness journey"',
    platforms: ['tiktok', 'instagram', 'youtube'],
    duration: '60s',
    estimatedTime: '1-2 hours',
    applicableCategories: ['skincare', 'makeup', 'haircare', 'bodycare'],
    hashtags: ['#ThatGirl', '#MorningRoutine', '#Wellness', '#SelfCare', '#Aesthetic'],
    defaultScenes: [
      '5AM wake up aesthetic',
    ...
    defaultDialogues: [
      'Becoming that girl one day at a time',
      'Morning routine that changed my life',
      'Self-care is not optional',
      'This product is part of my routine now',
      'Taking care of yourself is the goal',
    ],
  },
  {
    id: 'us_pov',
    type: 'POV',
    title: 'POV Story Content',
    titleKr: 'POV 스토리',
    subtitle: 'Point of View Storytelling',
    description: 'Engage viewers with POV storytelling while showcasing products',
    culturalNotes: 'POV content creates immersive experience. Relatable scenarios work best.',
    toneGuide: 'Immersive, relatable. "POV: you finally found...", "POV: your friend recommends..."',
    platforms: ['tiktok', 'instagram'],
    duration: '30s',
    estimatedTime: '1 hour',
    applicableCategories: ['skincare', 'makeup', 'haircare', 'bodycare', 'fragrance'],
    hashtags: ['#POV', '#RelateableContent', '#BeautyPOV', '#Storytelling'],
    defaultScenes: [
      'Set the POV scenario',
    ...
    defaultDialogues: [
      ...
      'Then your friend recommends this',
  ...
  },
  {
    ...
    titleKr: '바이럴 제품 테스트',
    subtitle: 'Putting Viral Products to the Test',
    description: 'Test trending viral products with honest reactions',
    culturalNotes: 'Americans love watching viral product tests with genuine reactions and results.',
    toneGuide: 'Curious, honest. "Is it worth the hype?", "Testing viral products!"',
    platforms: ['tiktok', 'youtube'],
    duration: '60s',
    estimatedTime: '1-2 hours',
    applicableCategories: ['skincare', 'makeup', 'haircare', 'bodycare', 'nail', 'tool'],
    hashtags: ['#ViralProducts', '#ProductTest', '#WorthTheHype', '#TestingViral'],
    defaultScenes: [
      'Introduce the viral product',
      'Show social proof/views',
      'First application test',
      'Wait for results',
      'Final honest verdict',
    ],
    defaultDialogues: [
      'Testing this viral product with millions of views',
      'Everyone says this is amazing',
  ...
  },
  {
    ...
    titleKr: '소프트걸 에스테틱',
    subtitle: 'Soft & Feminine Beauty',
    description: 'Soft, feminine aesthetic with gentle beauty products',
    culturalNotes: 'Soft girl aesthetic features pastel colors, gentle makeup, and feminine vibes.',
    toneGuide: 'Soft, gentle. "Soft girl makeup", "Feminine and pretty"',
    platforms: ['tiktok', 'instagram'],
    duration: '30s',
    estimatedTime: '1 hour',
    applicableCategories: ['makeup', 'skincare', 'nail', 'fragrance'],
    hashtags: ['#SoftGirl', '#SoftGirlAesthetic', '#FeminineBeauty', '#PrettyMakeup'],
    defaultScenes: [
      'Clean soft base',
      'Blush focus',
      'Glossy lips',
      'Soft eye look',
      'Final soft girl look',
    ],
    defaultDialogues: [
      'Soft girl makeup tutorial',
      'It\'s all about the blush',
      'Glossy lips are a must',
      'Keep it soft and pretty',
      'Soft girl era activated!',
    ],
  },
  {
    id: 'us_skincare_layer',
    type: 'Layering',
    title: 'Skincare Layering 101',
    titleKr: '스킨케어 레이어링',
    subtitle: 'How to Layer Products',
    description: 'Educational content on proper skincare layering technique',
    culturalNotes: 'Americans are increasingly interested in K-beauty inspired layering techniques.',
    toneGuide: 'Educational, helpful. "How to layer", "The right order"',
    platforms: ['youtube', 'tiktok', 'instagram'],
    duration: '60s',
    estimatedTime: '1-2 hours',
    applicableCategories: ['skincare'],
    hashtags: ['#SkincareLayering', '#SkincareTips', '#HowToLayer', '#SkincareRoutine'],
    defaultScenes: [
      'Show all products to layer',
      'Explain layering order',
      'Apply each step',
      'Feature product highlight',
      'Final glowing result',
    ],
    defaultDialogues: [
      'Let me teach you how to layer skincare',
      'Always go thin to thick',
      'This is where this product fits',
      'The key is letting each layer absorb',
      'Look at this glow!',
    ],
  },
]
...
export const JAPAN_TEMPLATES = [
  ...
  // 신규 트렌드 템플릿 (2024-2025)
  {
    ...
    title: '時短メイク',
    titleKr: '시간단축 메이크업',
    subtitle: 'Quick Makeup Tutorial',
    description: '忙しい朝でも5分で完成するメイク術',
    culturalNotes: '忙しい日本人女性に人気の時短コンテンツ。効率性と実用性を重視。',
    toneGuide: '効率的で実用的なトーン。「5分で完成」「朝の忙しい時間に」',
    platforms: ['tiktok', 'instagram'],
    duration: '30s',
    estimatedTime: '30分',
    applicableCategories: ['makeup', 'skincare'],
    hashtags: ['#時短メイク', '#5分メイク', '#朝活', '#忙しい朝', '#簡単メイク'],
    defaultScenes: [
      'タイマー表示でスタート',
      'ベースをサッと塗る',
      'ポイントメイク1ステップ',
  ...
  },
  {
    ...
    title: '韓国コスメレビュー',
    titleKr: 'K뷰티 리뷰',
    subtitle: 'Korean Beauty Review',
    description: '人気の韓国コスメを日本人目線でレビュー',
    culturalNotes: '日本ではK-beauty が大人気。韓国コスメへの関心が高い。',
    toneGuide: 'トレンドに敏感なトーン。「韓国で人気」「日本上陸」',
    platforms: ['tiktok', 'youtube', 'instagram'],
    duration: '60s',
    estimatedTime: '1時間',
    applicableCategories: ['skincare', 'makeup', 'haircare', 'bodycare'],
    hashtags: ['#韓国コスメ', '#Kビューティー', '#韓国スキンケア', '#韓国メイク', '#올리브영'],
    defaultScenes: [
      '韓国で話題の商品紹介',
      'パッケージの特徴',
      'テクスチャー確認',
  ...
  },
  {
    ...
    title: 'ミニマムスキンケア',
    titleKr: '미니멀 스킨케어',
    subtitle: 'Minimalist Skincare',
    description: '必要最小限のアイテムで最大効果を出すスキンケア',
    culturalNotes: 'ミニマリスト志向の日本人に人気。シンプルで効果的なケアが好まれる。',
    toneGuide: 'シンプルで落ち着いたトーン。「これだけでOK」「厳選アイテム」',
    platforms: ['youtube', 'instagram'],
    duration: '60s',
    estimatedTime: '1時間',
    applicableCategories: ['skincare'],
    hashtags: ['#ミニマムスキンケア', '#シンプルケア', '#ミニマリスト', '#厳選コスメ'],
    defaultScenes: [
      '使用アイテム全部見せ（少数）',
      '選んだ理由説明',
      'シンプルな使い方',
  ...
  },
  {
    ...
    title: 'お風呂ルーティン',
    titleKr: '배스 루틴',
    subtitle: 'Bath Time Routine',
    description: 'リラックスできるお風呂タイムのルーティン紹介',
    culturalNotes: '日本のお風呂文化は独特。リラックスと美容を兼ねたバスタイムが人気。',
    toneGuide: 'リラックスした穏やかなトーン。「お風呂タイム」「リラックス」',
    platforms: ['youtube', 'tiktok'],
    duration: '90s+',
    estimatedTime: '2時間',
    applicableCategories: ['bodycare', 'haircare', 'skincare'],
    hashtags: ['#お風呂ルーティン', '#バスタイム', '#リラックス', '#ボディケア', '#ナイトルーティン'],
    defaultScenes: [
      'バスルーム紹介',
      'バスソルト/入浴剤',
      'ボディケア製品使用',
  ...
  },
  {
    ...
    title: '100均コスメ',
    titleKr: '100엔샵 코스메',
    subtitle: '100 Yen Shop Beauty',
    description: '100円ショップで見つけた優秀コスメをレビュー',
    culturalNotes: '日本の100均コスメは品質が高い。コスパ重視の消費者に人気。',
    toneGuide: 'お得感を伝えるトーン。「100円でこの品質！」「見つけた！」',
    platforms: ['tiktok', 'instagram'],
    duration: '30s',
    estimatedTime: '30分',
    applicableCategories: ['makeup', 'nail', 'tool', 'skincare'],
    hashtags: ['#100均コスメ', '#ダイソー', '#セリア', '#プチプラ', '#100円コスメ'],
    defaultScenes: [
      '100均で見つけた商品紹介',
      '価格強調（100円！）',
      '実際に使ってみる',
  ...
  },
  {
    ...
    title: 'ゆる美容',
    titleKr: '느긋한 뷰티',
    subtitle: 'Relaxed Beauty Routine',
    description: '頑張りすぎない、ゆるっとした美容スタイル',
    culturalNotes: '完璧を求めない「ゆる美容」が若い世代に人気。無理なく続けられるケア。',
    toneGuide: 'ゆるくて親しみやすいトーン。「頑張りすぎない」「ゆるっと」',
    platforms: ['youtube', 'tiktok', 'instagram'],
    duration: '60s',
    estimatedTime: '1時間',
    applicableCategories: ['skincare', 'makeup', 'haircare', 'bodycare'],
    hashtags: ['#ゆる美容', '#頑張らない美容', '#ズボラ美容', '#シンプルケア'],
    defaultScenes: [
      'ゆるい雰囲気でスタート',
      '毎日続けられる簡単ケア',
      '製品の楽な使い方',
