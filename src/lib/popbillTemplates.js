...
export const POPBILL_TEMPLATES = {
  ...
  CREATOR: {
    ...
    CAMPAIGN_INVITATION: {
      code: '025110001005',
      name: '캠페인 초대장',
      description: '기업이 크넥 추천 크리에이터에게 보내는 캠페인 초대장',
      params: ['크리에이터명', '기업명', '캠페인명', '패키지타입', '보상금액', '마감일', '캠페인링크', '만료일']
    }
  },
  ...
  INVITATION: {
    ...
    CREATOR_APPLIED: {
      code: '025110000797',
      name: '추천 크리에이터 지원 완료',
      description: '초대한 추천 크리에이터가 캠페인에 지원했을 때 기업에게 발송',
      params: ['기업명', '크리에이터명', '주요채널', '팔로워수', '캠페인명', '캠페인관리링크']
    }
  }
};
