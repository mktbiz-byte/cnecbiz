...
function Card({
  ...
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-white text-card-foreground flex flex-col gap-4 rounded-xl border border-gray-100 py-5 transition-all duration-200",
...
function CardTitle({
  ...
  return (
    <div
      ...
      className={cn("leading-none font-semibold text-gray-900 text-base", className)}
      {...props} />
  );
}
