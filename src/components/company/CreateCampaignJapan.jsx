      ...
      <div className="bg-gray-50 pt-16 pb-6 lg:pt-8 lg:pb-8 lg:py-12">
        ...
        <div className="text-center mb-6 lg:mb-8">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <h1 className="text-xl lg:text-3xl font-bold text-gray-900">일본 캠페인 생성</h1>
          </div>
          <p className="text-gray-500 text-sm lg:text-base">일본 시장 대상 인플루언서 마케팅 캠페인</p>
          <p className="text-indigo-600 text-xs lg:text-sm mt-2 font-medium">한국어로 작성 후 마지막에 AI 번역 버튼으로 일본어로 변환됩니다</p>
        </div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-8">
              ...
              <div className="lg:col-span-2 space-y-4 lg:space-y-8">
                ...
                {campaignForm.campaign_type === 'megawari' && (
                  <div className="bg-white rounded-2xl p-4 lg:p-8 shadow-sm border-2 border-orange-200">
                    <h3 className="font-bold text-orange-800 mb-4 flex items-center gap-2 text-base lg:text-lg">
                      메가와리 스케줄
                    </h3>
                    <div className="space-y-4 lg:space-y-6">
                      {/* 영상 제출 마감일 */}
