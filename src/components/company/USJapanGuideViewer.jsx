...
import { Edit, Save, X, Copy, Film, MessageSquare, Lightbulb, Camera, Sparkles, Globe, FileText, ExternalLink } from 'lucide-react'
      ...
      <div className="space-y-5">
        ...
        <div className="flex items-center gap-2 pb-3 border-b border-gray-100">
          <div className={`w-8 h-8 rounded-lg flex items-center justify-center shadow-md ${
            ...
            {isPdf ? <FileText className="w-4 h-4 text-white" /> : <ExternalLink className="w-4 h-4 text-white" />}
          </div>
