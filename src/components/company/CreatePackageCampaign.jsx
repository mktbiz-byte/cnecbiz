              ...
              <div className="p-5 lg:p-8 space-y-6">
                ...
                <div>
                  ...
                  <div className="bg-[#F8F9FA] rounded-xl p-4 text-sm text-[#636E72] space-y-3">
                    ...
                    <p className="text-xs text-[#B2BEC3] mt-2">※ "캠페인 활성화"의 기준: 크리에이터 모집이 시작되는 시점</p>
